...
const AdminDashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      const privateMessagesRes = await fetch('http://localhost:5000/api/private-messages/admin', {
        headers: {
          'Authorization': `Bearer ${adminToken}`
        }
      });
      ...
      const groupMessagesRes = await fetch('http://localhost:5000/api/messages');
      ...
      const premiumCampaignsRes = await fetch('http://localhost:5000/api/premium-campaigns');
      ...
      const premiumOrdersRes = await fetch('http://localhost:5000/api/premium-orders', {
        headers: {
          'Authorization': `Bearer ${adminToken}`
        }
      });
